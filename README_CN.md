...
### 完整教程+开发板和电机购买链接 https://wiki.seeedstudio.com/stackforce_series/

![硬件连接说明](https://files.seeedstudio.com/wiki/robotics/Actuator/stackforce/Hardware_connect.png)
...
程序默认会控制 ID 为 0x01 的电机，在运行过程中可以通过键盘输入目标角度值。
